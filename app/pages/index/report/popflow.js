...
// 声明组件  并对外输出
export default class popflow extends Component {
  // 初始化页面常量 绑定事件方法
  constructor(props) {
    super(props)
    this.state = {
  ...
  init(){
    ...
    const _pie = echarts.init(_self.pie, theme) // 
  ...
  render() {
    ...
    return (
      <div className="echart-wrap">
        <div className="subtext" style={{position:'absolute', left: '110px', top: '13px', color: '#fff', zIndex: '555'}}>
