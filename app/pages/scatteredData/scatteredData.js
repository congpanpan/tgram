...
// 声明组件  并对外输出
export default class scatteredData extends Component {
  // 初始化页面常量 绑定事件方法
  constructor(props) {
    super(props)
    this.state = {
    ...
    this.appAddTitle = this.appAddTitle.bind(this)
  }
      ...
      <div className="body" style={{height:$GLOBALCONFIG.PAGEHEIGHT-20+'px'}}>
        ...
        <Panel>
          <div className="hjt-dataApp info">
            <Row gutter={15}>
              <Col span="12">
                <Card title="本月新增零散数据" extra={<Link to={`/dataApp/appList`}>更多</Link>}>
